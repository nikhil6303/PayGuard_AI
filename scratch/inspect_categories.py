...
categories = set(r["category"] for r in gt_rows)
...
for cat in categories:
    ...
    for sample in samples:
        ...
        if ord_rec and pay_rec and set_rec:
            ...
            print(f"Calculations: Order Amt={o_amt}, Pay Amt={p_amt}, Settled={s_amt}, Fee(2%)={fee_2pct}, ExpNet(order-fee)={expected_net}, Settled/ExpNet Diff={s_amt - expected_net:.2f}")
